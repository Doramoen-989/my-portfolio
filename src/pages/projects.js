          ...
          <div className="grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0">
            ...
            <div className="col-span-6 sm:col-span-12">
              <Project
                ...
                title="Jobster"
                img={proj2}
                link="https://jobster-tawny.vercel.app/landing"
                github="https://github.com/Doramoen-989/Jobster"
              />
            </div>
            <div className="col-span-6 sm:col-span-12">
              <Project
                ...
                title="Comfy-Sloth"
                img={proj3}
                link="https://vercel.com/leelavathis-projects/comfy-sloth"
                github="https://github.com/Doramoen-989/comfy-sloth"
              />
            </div>
            <div className="col-span-6 sm:col-span-12">
              <Project
                ...
                title="Recipe-App"
                img={proj4}
                link="https://vercel.com/leelavathis-projects/recipe-app"
                github="https://github.com/Doramoen-989/Recipe-app"
              />
            </div>
            <div className="col-span-6 sm:col-span-12">
              <Project
                ...
                title="E-Commerce"
                img={proj5}
                link="https://vercel.com/leelavathis-projects/e-commerce"
                github="https://github.com/Doramoen-989/e-commerce"
              />
            </div>
            {/* <div className="col-span-6 sm:col-span-12">
              <Project
