      ...
      {/* <div ref={ref} className="relative w-[75%] mx-auto lg:w-[90%] md:w-full">
        ...
        <ul className="w-full flex flex-col items-start justify-between ml-4">
          <Details
            ...
            time="2017-2021"
            place="Nuzvid (IIIT)"
            info="I completed a bachelor's degree in mechanical engineering and undertook a 
            project focused on Extracting maximum solar energy from the sun by a rotating plate. 
